...
import com.project.professor.alocation.service.DepartmentService;
...
public class DepartmentController {
	...
	public ResponseEntity<Department> findById(@PathVariable(name = "department_id", required = true) Long id){
	...
	public ResponseEntity<Department> update(@PathVariable(name = "department_id", required = true) Long id,@RequestBody Department department){
	...
	public ResponseEntity<Void> deleteById(@PathVariable(name = "department_id", required = true) Long id){
