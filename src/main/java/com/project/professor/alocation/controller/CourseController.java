...
public class CourseController {
	...
	public ResponseEntity<Course> findById(@PathVariable(name = "course_id", required = true) Long id){
	...
	public ResponseEntity<Course> update(@PathVariable(name = "course_id", required = true) Long id,@RequestBody Course course){
	...
	public ResponseEntity<Void> deleteById(@PathVariable(name = "course_id", required = true) Long id){
